...
import 'package:flutter_user/pages/onTripPage/edit_drop_location.dart';
...
String editDropLat = '';
String editDropLng = '';
String newDropAddressConfirmation = '';
  ...
  addPickDropMarker() async {
    if (mapType == 'google') {
      ...
      if (addressList.length > 1 &&
        ...
        fmController.move(fmlt.LatLng(_center.latitude, _center.longitude), 13);
      }
    }
  }
                                                              ...
                                                              fm.Marker(
                                                                  ...
                                                                  point: fmlt.LatLng(
                                                                      ...
                                                                      addressList[k]
                                                                          .latlng
                                                                          .longitude),
                                                                  width: (k == 0 || k == addressList.length - 1)
                                                                      ? media.width *
                                                                          0.7
                                                                      : 10,
                                                                  height: (k == 0 ||
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                              MyText(
                                                                            text:
                                                                                languages[choosenLanguage]['text_availablerides'],
                                                                            size:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          if (updateAmount
                                                                            ...
                                                                            await FirebaseDatabase.instance.ref().child('bid-meta/${userRequestData["id"]}').update({
                                                                              'price': updateAmount.text,
                                                                              'updated_at': ServerValue.timestamp,
                                                                            });
                                                                            await FirebaseDatabase.instance.ref().child('bid-meta/${userRequestData["id"]}/drivers').remove();
                                                                            setState(() {
                                                                              updateAmount.clear();
                                                                              isLoading = false;
                                                                            });
                                                                        ...
                                                                        InkWell(
                                                                          onTap:
                                                                            ...
                                                                            if (userRequestData.isNotEmpty &&
                                                                              ...
                                                                              polyline.clear();
                                                                              fmpoly.clear();
                                                                              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => EditDropLocation()));
                                                                              testingId = userRequestData['id'].toString();
                                                                            }
                                                                          },
                                                                          child:
                                                                              Container(
                                                                            padding:
                                                                                EdgeInsets.all(media.width * 0.03),
                                                                            decoration:
                                                                                BoxDecoration(color: Colors.grey.withOpacity(0.1), borderRadius: BorderRadius.circular(media.width * 0.02)),
                                                                            child:
                                                                                Row(
                                                                              mainAxisAlignment: MainAxisAlignment.start,
                                                                              crossAxisAlignment: CrossAxisAlignment.start,
                                                                              children: [
                                                                                ...
                                                                                if (userRequestData.isNotEmpty && userRequestData['is_trip_start'] == 1 && addressList.length < 2)
                                                                                  Container(
                                                                                    height: media.width * 0.05,
                                                                                    width: media.width * 0.05,
                                                                                    alignment: Alignment.center,
                                                                                    child: const Icon(Icons.edit, color: Color(0xffF52D56)),
                                                                                  ),
                                                                              ],
                                                                            ),
                                                                          ),
                                                  ...
                                                  children: [
                                                              ...
                                                              InkWell(
                                                                ...
                                                                child:
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      border: Border(
                                                                          bottom:
                                                                              BorderSide(color: (isFromDate) ? hintColor : page))),
                                                                  child: MyText(
                                                                    text: languages[
                                                                            choosenLanguage]
                                                                        [
                                                              ...
                                                              InkWell(
                                                                onTap: () {
                                                                  setState(() {
                                                                    isFromDate =
                                                                        false;
                                                                    toDate = fromDate.add(const Duration(
                                                                        days: 1,
                                                                        minutes:
                                                                            2));
                                                                  });
                                                    ...
                                                    (isFromDate)
                                                        ...
                                                        : Container(
                                                            ...
                                                            child:
                                                                CupertinoDatePicker(
                                                                    minimumDate: fromDate.add(const Duration(
                                                                        days: 1,
                                                                        minutes:
                                                                            10)),
                                                                    initialDateTime: fromDate.add(const Duration(
                                                                        days: 1,
                                                                        minutes:
                                                                            10)),
                                                                    maximumDate:
  ...
  animateCar(
    ...
    if (userRequestData.isNotEmpty && userRequestData['accepted_at'] != null) {
      if (mapType == 'google') {
        ...
        if (fmController.camera.visibleBounds
                .contains(fmlt.LatLng(toLat, toLong)) ==
            false) {
          fmController.move(fmlt.LatLng(toLat, toLong), 16);
        }
      }
    }
  }

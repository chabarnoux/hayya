   ...
   <div class="header-menu">
      ...
      <div class="booking_info">
         {{-- <div id="mapImageContainer">
            <img id="mapImage" style="width:100%" src="https://maps.googleapis.com/maps/api/staticmap?center={{ $request->lat }},{{ $request->lng }}&zoom=15&size=600x300&markers=icon:https://maps.google.com/mapfiles/ms/icons/blue-dot.png|{{ $request->lat }},{{ $request->lng }}&key={{ get_settings('google_map_key') }}">
         </div> --}}

...
@endif        
        <div class="hidden lg:flex lg:w-1/2">
            <img src="{{ asset('images/Track3.jpg') }}" alt="" class="rounded w-full object-cover">
        </div>
    </div>
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key={{ get_settings('google_map_key') }}'google_map_key')}}&sensor=false&libraries=places"></script>

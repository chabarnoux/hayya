                      ...
                      <div class="textOnInput mt-5">
                          <label for="pickup" class="form-label">Pickup</label>
                            ...
                            <div class="autocomplete-container">
                                ...
                                <input id="pick-input" class="form-control controls" type="text" placeholder="@lang('view_pages.search')" />
                                <div id="pick-results" class="autocomplete-results"></div>
                            </div>
                      ...
                      <div class="textOnInput mt-10">
                          <label for="drop" class="form-label">Drop</label>
                            ...
                            <div class="autocomplete-container">
                                ...
                                <input id="drop-input" class="form-control controls" type="text" placeholder="@lang('view_pages.search')" />
                                <div id="drop-results" class="autocomplete-results"></div>
                            </div>
...
<script>
  let appUrl = '{{ url("/") }}';
  let google_map_key = "{{get_settings('google_map_key')}}";
</script>
<script src="{{ asset('assets/js/dispatcher/book-ride.js') }}"></script>
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key={{ get_settings('google_map_key') }}'google_map_key')}}&libraries=places" async defer></script>
